...
class Draco3Config(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.algo.loss.cross_entropy_weight = 0.0     # cross entropy loss weight
        self.algo.loss.log_probs_weight = 0.0
        self.algo.gmm.discrete_indices =[]
        self.algo.gmm.discrete_classes =[]
        self.algo.gmm.discrete_trg_config =[]
