...
class Draco3(HumanoidModel):
    ...
    def _set_key_map(self):
        ...
        self._key_map['joint'].update({key: self.naming_prefix+value for key, value in DRACO3_MAP['joint'].items()})
        self._key_map['actuator'].update({key: self.naming_prefix+value for key, value in DRACO3_MAP['actuator'].items()})
