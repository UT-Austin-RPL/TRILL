...
class DracoManipulationTCIContainer(TCIContainer):
    def __init__(self, robot, config):
        ...
        self._task_list = [
            self._com_task, 
            # self._cam_task, 
            self._torso_ori_task, self._upper_body_task,
            self._lhand_pos_task, self._lhand_ori_task, self._rhand_pos_task, self._rhand_ori_task, 
            self._rfoot_pos_task, self._lfoot_pos_task, self._rfoot_ori_task, self._lfoot_ori_task
        ]
        ...
        hierachy_keys = [
            ...
            # 'CAM',
            'Torso', 'Upper Body',
            'Hand Pos Min', 'Hand Pos Min', 'Hand Quat Min', 'Hand Quat Min',
            'Contact Foot', 'Contact Foot', 'Contact Foot', 'Contact Foot'
        ]
        ...
        gain_keys = [
            ...
            # 'CAM',
            'Torso', 'Upper Body',
            'Hand Pos', 'Hand Pos', 'Hand Quat', 'Hand Quat',
            'Foot Pos', 'Foot Pos', 'Foot Quat', 'Foot Quat'
        ]

        for task, hiearchy_key, gain_key in zip(self._task_list, hierachy_keys, gain_keys):
